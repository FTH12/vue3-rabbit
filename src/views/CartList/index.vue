...
const selectedChange = (selected, skuId)=>{
      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="cartStore.selectAll" @change="allChange"/>
              </th>
          ...
          <tbody>
            <tr v-for="i in cartStore.cartList" :key="i.id">
              <td>
                <el-checkbox :model-value="i.selected" @change="(selected)=>selectedChange(selected, i.skuId)" />
              </td>
              <td>
                <div class="goods">
